    ...
    return(
        <div className="flex flex-col w-[90vw] justify-center gap-4">
            <div className="bg-white md:w-[60vw] p-[20px] rounded-[20px] flex justify-center items-center flex-col md:mx-auto">
                ...
                <div className="mt-4 md:mt-8 bg-white mx-auto w-[90vw] p-[30px] gap-2 grid-cols-2 grid md:grid-cols-4">
                    {ingredients.map((x, i)=> <Ingredient key={i} name={x} onClick={async () => {
                        setInput(x);
