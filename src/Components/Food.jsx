...
function Food(f){
    ...
    return(
        <div className="flex flex-col p-[10px] border-black border-[2px] rounded-xl">
            ...
            <div className={show ? (loading ? "flex justify-center items-center ":"" +"visible fixed w-[90vw] md:w-[50vw] h-[90vh] backdrop-blur-xl border-[var(--primary-color)] border-[2px] rounded-lg p-[20px] z-10 transition duration-1000 overflow-hidden overflow-y-scroll selfScroll top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] flex justify-center items-center") : "hidden"}>
